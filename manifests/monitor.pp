...
# [*start_script*]    - Script used to start the process
# [*stop_script*]     - Script used to start the process
# [*every_cycles*]    - the numebr - should it gbe check every X cycles of monit
#
# === Examples
#
...
define monit::monitor (
  ...
  #                 $program_timeout, for process - $every_cycles
